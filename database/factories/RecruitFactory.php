...
class RecruitFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'recruit_type' => fake()->randomElement(array_keys($recruit_types)),
            ...
            'payment_type' => fake()->randomElement(array_keys($payment_types)),
            'payment' => mt_rand(0, 4) ? mt_rand(1000, 10000) : null,
            'commutation_type' => fake()->randomElement(array_keys($commutation_types)),
