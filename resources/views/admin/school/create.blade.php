      ...
      <div>
        <form action="/admin/school/create" method="post">
          ...
          <div>
            ...
            <input type="text" name="email" id="email" class="edit__input" value="{{ old('email') }}">
          ...
          <div>
            ...
            <input type="text" name="name" id="name" class="edit__input" placeholder="○○小学校"
              value="{{ old('name')}}">
            @error('zip') <p class="alert">{{ $message }}</p> @enderror
          </div>
          <div>
            <label for="zip" class="edit__label">郵便番号</label>
            <input type="text" name="zip" id="zip" class="edit__input" placeholder="1638001"
              value="{{ old('zip')}}">
            @error('zip') <p class="alert">{{ $message }}</p> @enderror
          </div>
          <div>
            <label for="pref" class="edit__label">都道府県</label>
            <input type="text" name="pref" id="pref" class="edit__input" placeholder="東京都"
              value="{{ old('pref')}}">
            @error('pref') <p class="alert">{{ $message }}</p> @enderror
          </div>
          <div>
            <label for="city" class="edit__label">市区町村</label>
            <input type="text" name="city" id="city" class="edit__input" placeholder="新宿区"
              value="{{ old('city')}}">
            @error('city') <p class="alert">{{ $message }}</p> @enderror
          </div>
          <div>
            <label for="address" class="edit__label">町域・番地・建物名など</label>
            <input type="text" name="address" id="address" class="edit__input" placeholder="西新宿２－８－１"
              value="{{ old('address')}}">
            @error('address') <p class="alert">{{ $message }}</p> @enderror
          </div>
          <div>
            <label for="tel1" class="edit__label">電話番号１</label>
            <input type="text" name="tel1" class="edit__input" placeholder="08012345678" value="{{ old('tel1')}}">
            @error('tel1') <p class="alert">{{ $message }}</p> @enderror
          </div>
          <div>
            <label for="tel2" class="edit__label">電話番号２</label>
            <input type="text" name="tel2" class="edit__input" placeholder="08012345678" value="{{ old('tel2')}}">
            @error('tel2') <p class="alert">{{ $message }}</p> @enderror
          </div>
          <div>
            <label for="charge" class="edit__label">担当者名</label>
            <input type="text" name="charge" class="edit__input" placeholder="" value="{{ old('charge')}}">
