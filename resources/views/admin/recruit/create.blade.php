<x-admin-layout>
  <article class="contents">
    <div class="contents__inner">
      ...
      <div>
        <form action="/admin/recruit/create" method="post">
          @csrf
            ...
            <select name="recruit_type" class="edit__select">
              @foreach ($arrRecruitType as $key => $value)
                <option class="edit__option" value="{{ $key }}"
                  @selected(old('recruit_type') === $key)>{{ $value }}
                </option>
              @endforeach
            </select>
          </div>
          ...
          <div class="edit__item">
            <label for="other_activities" class="edit__label">募集する活動<br>（その他）</label>
            <input type="text" name="other_activities" id="other_activities"
              class="edit__input" value="{{ old('other_activities') }}">
          ...
          <div class="edit__item">
            ...
            <input type="text" name="ontime" id="ontime" class="edit__input"
              value="{{ old('ontime') }}">
            @error('ontime')
              <p class="alert">{{ $message }}</p>
            @enderror
          ...
          <div class="edit__item">
            ...
            <select name="payment_type" id="payment_type" class="edit__select">
              @foreach ($arrPaymentType as $key => $value)
                <option class="edit__option" value="{{ $key }}"
                  @selected(old('payment_type') === $key)>{{ $value }}
                </option>
              @endforeach
            </select>
            @error('payment_type')
          ...
          <div class="edit__item">
            ...
            <input type="number" name="payment" id="payment" class="edit__input"
              value="{{ old('payment') }}">
            @error('payment')
              <p class="alert">{{ $message }}</p>
            @enderror
          ...
          <div class="edit__item">
            ...
            <select name="commutation_type" id="commutation_type" class="edit__select">
              @foreach ($arrCommutationType as $key => $value)
                <option class="edit__option" value="{{ $key }}"
                  @selected(old('commutation_type') === $key)>{{ $value }}
                </option>
              @endforeach
            </select>
          </div>
          ...
          <div class="edit__item">
            ...
            <input type="number" name="commutation" id="commutation" class="edit__input"
              value="{{ old('commutation') }}">
            @error('commutation')
              <p class="alert">{{ $message }}</p>
            @enderror
          </div>
          ...
          <div class="edit__item">
            ...
            <input type="number" name="number" id="number" class="edit__input"
              value="{{ old('number') }}">
            @error('number')
              <p class="alert">{{ $message }}</p>
            @enderror
          ...
          <div class="edit__item">
            ...
            <select name="status" class="edit__select">
              @foreach ($arrStatus as $key => $value)
                <option class="edit__option" value="{{ $key }}"
                  @selected(old('status') === $key)>{{ $value }}</option>
              @endforeach
            </select>
          </div>
          ...
          <div class="edit__item">
            ...
            <input type="date" name="end_date" id="end_date" class="edit__input"
              value="{{ old('end_date') }}">
            @error('end_date')
              <p class="alert">{{ $message }}</p>
            @enderror
