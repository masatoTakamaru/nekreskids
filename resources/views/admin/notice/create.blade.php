      ...
      <div>
        <form action="/admin/notice/create" method="post">
          ...
          <div class="edit__item">
            ...
            <div>
              <textarea name="content" class="content__content" id="content__content" cols="50"
                rows="10">{{ old('content') }}</textarea>
              <p class="edit__content-count" id="content__count"></p>
            </div>
          </div>
          <div class="edit__item">
            <label for="publish_date" class="">告知日</label>
            <input type="date" name="publish_date" id="publish_date" class=""
