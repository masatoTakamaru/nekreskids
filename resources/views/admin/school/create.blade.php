      ...
      <div>
        <form action="/admin/school/create" method="post">
          ...
          <div>
            ...
            <input type="text" name="zip" id="zip" class="edit__input"
          ...
          <div>
            ...
            <input type="text" name="pref" id="pref" class="edit__input"
          ...
          <div>
            ...
            <input type="text" name="city" id="city" class="edit__input"
          ...
          <div>
            ...
            <input type="text" name="address" id="address" class="edit__input"
          ...
          <div>
            ...
            <input type="text" name="charge" class="edit__input" placeholder=""
              value="{{ old('charge') }}">
            @error('charge')
              <p class="alert">{{ $message }}</p>
            @enderror
