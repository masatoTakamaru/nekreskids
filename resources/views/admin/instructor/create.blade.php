      ...
      <div>
        <form action="/admin/instructor/create" method="post">
          ...
          <div class="edit__item">
            ...
            <input type="text" name="email" id="email" class="editInput" value="{{ old('email') }}">
          ...
          <div class="edit__item">
            ...
            <input type="text" name="name" class="editInput" value="{{ old('name') }}">
            @error('name') <p class="alert">{{ $message }}</p> @enderror
          </div>
          <div class="edit__item">
            <label for="name_kana" class="editLabel">氏名カナ</label>
            <input type="text" name="name_kana" class="editInput" value="{{ old('name_kana') }}">
          ...
          <div class="edit__item">
            ...
            <input type="hidden" name="birth" id="birth" value="{{ old('birth') }}">
          </div>
          <div class="edit__item">
            <span class="editLabel">性別</span>
            @foreach($genders as $key => $value)
            <input type="radio" name="gender" id="{{ $key }}" class="editRadio" value="{{ $key }}" @checked(old('gender')===$key)>
          ...
          <div class="edit__item">
            ...
            <input type="text" name="tel" class="" placeholder="08012345678" value="{{ old('tel')}}">
          ...
          <div class="edit__item">
            ...
            <input type="text" name="cert" class="" value="{{ old('cert') }}">
          </div>
          <div class="edit__item">
