      ...
      <div>
        <form action="/admin/recruit/create" method="post">
          ...
          <div class="edit__item">
            <label for="header" class="edit__label">学校名</label>
            <div>{{ $school_name }}</div>
          </div>
          ...
          <div class="edit__item">
            ...
            <input type="text" name="header" id="header"
              class="edit__input" value="{{ old('header') }}">
            @error('header')
          ...
          <div class="edit__item">
            ...
            <input type="text" name="ontime" id="ontime"
              class="edit__input" value="{{ old('ontime') }}">
            @error('ontime')
              <p class="edit__alert">{{ $message }}</p>
            @enderror
          </div>
          ...
          <div class="edit__item">
            ...
            <input type="number" name="payment" id="payment"
              class="edit__input" value="{{ old('payment') }}">
            @error('payment')
              <p class="edit__alert">{{ $message }}</p>
            @enderror
          </div>
          ...
          <div class="edit__item">
            ...
            <input type="number" name="number" id="number"
              class="edit__input" value="{{ old('number') }}">
            @error('number')
              <p class="edit__alert">{{ $message }}</p>
            @enderror
          </div>
          ...
          <div class="edit__item">
            ...
            <input type="date" name="end_date" id="end_date"
              class="edit__input" value="{{ old('end_date') }}">
            @error('end_date')
              <p class="edit__alert">{{ $message }}</p>
            @enderror
          </div>
