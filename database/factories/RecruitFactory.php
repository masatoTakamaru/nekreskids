...
class RecruitFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'recruit_type' => fake()->randomKeys($recruit_types),
            ...
            'payment_type' => fake()->randomKeys($payment_types),
            'payment' => mt_rand(0, 4) ? mt_rand(1000, 10000) : null,
            'commutation_type' => fake()->randomKeys($commutation_types),
            'commutation' => mt_rand(0, 4) ? mt_rand(1000, 10000) : null,
            'number' => mt_rand(1, 20),
            'status' => fake()->randomKeys($statuses),
